...
class HeadlessReversiCreator(object):
    ...
    def printFinalScore(self):
        ...
        if p1Stones > p2Stones:
            #print('Player', self.player1.name,'wins!')
            return self.player1.name
        elif p2Stones > p1Stones:
            #print('Player', self.player2.name,'wins!')
...
if __name__ == "__main__":
    ...
    if len(args) == 0:
        ...
        print(p1.name, p1score)
        print(p2.name, p2score)
        ...
        if importsCorrect:            
            ...
            for i in range(500):
                ...
                game = HeadlessReversiCreator(p2, p2_color, p1, p1_color, 8)
                winner = game.play_game()
                if winner == p1.name:
                    p1score += 1
                if winner == p2.name:
